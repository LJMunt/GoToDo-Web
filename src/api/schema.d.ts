...
export interface paths {
    ...
    "/api/v1/admin/orgs/{id}": {
        ...
        put?: never;
        post?: never;
        /** Permanent delete organization (admin) */
        delete: {
            parameters: {
                query?: never;
                header?: never;
