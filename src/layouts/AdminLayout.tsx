...
export default function AdminLayout() {
    ...
    const navItems = [
        ...
        {
            label: config.navigation.organizations,
                ...
                <nav className="flex flex-col gap-1 sticky top-6">
                    ...
                    {navItems.map((item) => (
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all text-sm font-medium border ${
                                    isActive
                                        ? "bg-brand-500/10 text-brand-500 border-brand-500/20 shadow-sm"
                                        : "text-text-muted border-transparent hover:bg-surface-5 hover:text-text-base hover:border-surface-10"
                                }`
                            }
                        >
